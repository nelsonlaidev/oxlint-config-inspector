...
- Node.js 22 or newer.
- The `oxlint` binary should be available on `PATH` when you want builtin rule
  metadata. If it is missing, the inspector still runs, but builtin rules cannot
  be cataloged and an error is logged.
